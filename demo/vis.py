...
def get_pose3D(video_path, output_dir):
    ...
    args.number_of_kept_frames, args.number_of_kept_coeffs = 3, 3
    args.pad = (args.frames - 1) // 2
    args.previous_dir = 'checkpoint/'
    args.n_joints, args.out_joints = 17, 17

    ## Reload 
    model = Model(num_joints = 17, num_frames=81, input_dim=2, output_dim=3)

    # Put the pretrained model of PoseFormerV2 in 'checkpoint/']
    model_path = sorted(glob.glob(os.path.join(args.previous_dir, 'lstm_model')))[0]
